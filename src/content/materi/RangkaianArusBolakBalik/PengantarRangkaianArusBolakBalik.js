const pengantarrlc = {
  ...
  content: [
    {
      blocks: [
        { type: "heading", text: "⚡ Mengapa Rangkaian AC Lebih Menarik?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "📍 Apa Itu Rangkaian RLC?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "⚖️ Mengapa Ketiganya Berbeda?" },
    ...
    {
      blocks: [
        { type: "heading", text: "🌍 Penerapan Rangkaian RLC" },
        {
          type: "paragraph",
