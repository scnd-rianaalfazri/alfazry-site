const gerakvertikalbawah = {
  ...
  content: [
    {
      blocks: [
        { type: "heading", text: "⬇️ Benda yang Bergerak Turun" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "📍 Apa Itu Gerak Vertikal ke Bawah?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "⚡ Ciri-Ciri GVB" },
    ...
    {
      blocks: [
        { type: "heading", text: "⚖️ Perbedaan GJB dan GVB" },
    ...
    {
      blocks: [
        { type: "heading", text: "🔄 Gabungan Gerak Vertikal" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🚀 Contoh Gabungan Gerak Vertikal" },
    ...
    {
      blocks: [
        { type: "heading", text: "📊 Pola Perubahan Kecepatan" },
