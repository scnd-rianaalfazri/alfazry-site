const geraklurusberaturan = {
  ...
  content: [
    {
      blocks: [
        { type: "heading", text: "🚗 Gerak dengan Kecepatan Tetap" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "✨ Ciri-Ciri GLB" },
    ...
    {
      blocks: [
        { type: "heading", text: "⏱️ Hubungan Jarak dan Waktu" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "📐 Persamaan GLB" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "📈 Grafik pada GLB" },
    ...
    {
      blocks: [
        { type: "heading", text: "🛣️ Contoh dalam Kehidupan" },
    ...
    {
      blocks: [
        { type: "heading", text: "🧠 Perbedaan GLB dan Gerak Biasa" },
        {
          type: "paragraph",
