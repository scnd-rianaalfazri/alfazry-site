const hukumnewtontiga = {
  ...
  content: [
    {
      blocks: [
        { type: "heading", text: "🚀 Ketika Gaya Tidak Seimbang" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "📍 Bunyi Hukum Newton II" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "⚖️ Hubungan Gaya, Massa, dan Percepatan" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🏎️ Contoh Sederhana" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🧠 Resultan Gaya" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🧩 Arah Percepatan" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "📊 Hubungan Massa dan Percepatan" },
    ...
    {
      blocks: [
        { type: "heading", text: "🌎 Makna Fisika dalam Kehidupan" },
