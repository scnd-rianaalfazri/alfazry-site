const menjumlahkanvektor = {
  ...
  content: [
...

    {
      ...
      body: [
        "Sebuah kapal bergerak karena kombinasi:",
        "",
        "🌊 arus air",
        "🚢 mesin kapal",
        "",
        "Gerakan akhir kapal merupakan hasil gabungan dua vektor tersebut."
      ]
    },

    {
      heading: "⚡ Contoh Penerapan Fisika",
      body: [
        "Penjumlahan vektor digunakan pada:",
        "",
        "💪 Resultan gaya",
        "🚀 Kecepatan benda",
        "🌎 Perpindahan",
