...
const menjumlahkanvektor = {
  ...
  { heading:
    ...
    "➕ Menjumlahkan Vektor Tidak Sama Seperti Angka Biasa", blocks: [{ type: "heading", text: "➕ Menjumlahkan Vektor Tidak Sama Seperti Angka Biasa"
    },
    {
      type: "image",
  ...
  { heading:
    ...
    "➡️ Vektor Segaris dengan Arah Sama", blocks: [{ type: "heading", text: "➡️ Vektor Segaris dengan Arah Sama" },
    {
      type: "image",
  ...
  { heading:
    ...
    "⬅️ Vektor Segaris dengan Arah Berlawanan", blocks: [{ type: "heading", text: "⬅️ Vektor Segaris dengan Arah Berlawanan" },
    {
      type: "image",
  ...
  { heading:
    ...
    "🔺 Penjumlahan Vektor dengan Metode Segitiga", blocks: [{ type: "heading", text: "🔺 Penjumlahan Vektor dengan Metode Segitiga"
    },
    {
      type: "image",
  ...
  { heading:
    ...
    "▱ Penjumlahan Vektor dengan Metode Jajargenjang", blocks: [{ type: "heading", text: "▱ Penjumlahan Vektor dengan Metode Jajargenjang"
    },
    {
      type: "image",
  ...
  { heading:
    ...
    "🧩 Penjumlahan Vektor Menggunakan Komponen", blocks: [{ type: "heading", text: "🧩 Penjumlahan Vektor Menggunakan Komponen" },
    {
      type: "image",
  ...
  { heading:
    ...
    "🚗 Contoh Penerapan Vektor dalam Kehidupan", blocks: [{ type: "heading", text: "🚗 Contoh Penerapan Vektor dalam Kehidupan" },
    {
      type: "image",
