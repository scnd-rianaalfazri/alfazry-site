const gerbanglogika = {
  ...
  { heading:
    ...
    "🤔 Bagaimana Komputer Mengambil Keputusan?", blocks: [{ type: "heading", text: "🤔 Bagaimana Komputer Mengambil Keputusan?" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🚪 Apa Itu Gerbang Logika?", blocks: [{ type: "heading", text: "🚪 Apa Itu Gerbang Logika?" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "✅ Gerbang AND", blocks: [{ type: "heading", text: "✅ Gerbang AND" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "✅ Gerbang OR", blocks: [{ type: "heading", text: "✅ Gerbang OR" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🔄 Gerbang NOT", blocks: [{ type: "heading", text: "🔄 Gerbang NOT" },
  ...
  { heading:
    ...
    "⚡ Gerbang Lainnya", blocks: [{ type: "heading", text: "⚡ Gerbang Lainnya" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "💻 Mengapa Gerbang Logika Penting?", blocks: [{ type: "heading", text: "💻 Mengapa Gerbang Logika Penting?" },
    {
      type: "paragraph",
