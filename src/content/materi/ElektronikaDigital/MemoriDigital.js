const memoridigital = {
  ...
  { heading:
    ...
    "🧠 Mengapa Komputer Bisa Mengingat?", blocks: [{ type: "heading", text: "🧠 Mengapa Komputer Bisa Mengingat?" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "💾 Apa Itu Memori Digital?", blocks: [{ type: "heading", text: "💾 Apa Itu Memori Digital?" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "⚡ RAM (Random Access Memory)", blocks: [{ type: "heading", text: "⚡ RAM (Random Access Memory)" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "📀 ROM (Read Only Memory)", blocks: [{ type: "heading", text: "📀 ROM (Read Only Memory)" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "💽 Media Penyimpanan", blocks: [{ type: "heading", text: "💽 Media Penyimpanan" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🔄 Bagaimana Data Disimpan?", blocks: [{ type: "heading", text: "🔄 Bagaimana Data Disimpan?" },
    {
      type: "paragraph",
