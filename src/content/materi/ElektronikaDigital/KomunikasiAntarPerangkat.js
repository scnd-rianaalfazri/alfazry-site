const komunikasiantarperangkat = {
  ...
  { heading:
    ...
    "💬 Mengapa Perangkat Elektronik Harus Berkomunikasi?", blocks: [{ type: "heading", text: "💬 Mengapa Perangkat Elektronik Harus Berkomunikasi?"
    },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🔌 Apa Itu Protokol Komunikasi?", blocks: [{ type: "heading", text: "🔌 Apa Itu Protokol Komunikasi?" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "📨 UART (Universal Asynchronous Receiver Transmitter)", blocks: [{ type: "heading", text: "📨 UART (Universal Asynchronous Receiver Transmitter)"
    },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "⚡ SPI (Serial Peripheral Interface)", blocks: [{ type: "heading", text: "⚡ SPI (Serial Peripheral Interface)" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🔗 I²C (Inter-Integrated Circuit)", blocks: [{ type: "heading", text: "🔗 I²C (Inter-Integrated Circuit)" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🚗 CAN (Controller Area Network)", blocks: [{ type: "heading", text: "🚗 CAN (Controller Area Network)" },
    {
      type: "paragraph",
