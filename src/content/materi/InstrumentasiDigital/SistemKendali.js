const sistemkendali = {
  ...
  { heading:
    ...
    "❄️ Mengapa AC Lebih 'Pintar' daripada Kipas Angin?", blocks: [{ type: "heading", text: "❄️ Mengapa AC Lebih 'Pintar' daripada Kipas Angin?"
    },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🎯 Apa Itu Sistem Kendali?", blocks: [{ type: "heading", text: "🎯 Apa Itu Sistem Kendali?" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🔄 Apa Itu Feedback?", blocks: [{ type: "heading", text: "🔄 Apa Itu Feedback?" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "📂 Sistem Kendali Terbuka (Open Loop)", blocks: [{ type: "heading", text: "📂 Sistem Kendali Terbuka (Open Loop)" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "📂 Contoh Open Loop", blocks: [{ type: "heading", text: "📂 Contoh Open Loop" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🔁 Sistem Kendali Tertutup (Closed Loop)", blocks: [{ type: "heading", text: "🔁 Sistem Kendali Tertutup (Closed Loop)" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "📂 Contoh Closed Loop", blocks: [{ type: "heading", text: "📂 Contoh Closed Loop" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🌍 Contoh Lain di Kehidupan", blocks: [{ type: "heading", text: "🌍 Contoh Lain di Kehidupan" },
    {
      type: "paragraph",
