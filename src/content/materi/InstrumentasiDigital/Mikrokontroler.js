const mikrokontroler = {
  ...
  content: [
    {
      blocks: [
        { type: "heading", text: "🧠 Siapa yang Mengambil Keputusan?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "💻 Apa Itu Mikrokontroler?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "⚙️ Bagaimana Mikrokontroler Bekerja?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🔌 Apa yang Bisa Dihubungkan?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🛠️ Contoh Mikrokontroler Populer" },
        {
          type: "paragraph",
