  ...
  content: [
    {
      blocks: [
        {
          type: "heading",
          text: "📊 Bagaimana Mikrokontroler Membaca Sensor?",
        },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "📥 Apa Itu Akuisisi Data?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🌡️ Dari Besaran Fisika Menjadi Angka" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🔄 Analog dan Digital" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "📈 Mengapa Data Digital Penting?" },
        {
          type: "paragraph",
