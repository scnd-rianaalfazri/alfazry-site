const aktuator = {
  ...
  content: [
    {
      blocks: [
        { type: "heading", text: "⚙️ Bagaimana Lampu Bisa Menyala Otomatis?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🔧 Apa Itu Aktuator?" },
        {
          type: "paragraph",
    ...
    },
    {
      blocks: [
        {
          type: "heading",
          text: "🧠 Hubungan Sensor, Mikrokontroler, dan Aktuator",
        },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "💡 Contoh Aktuator di Sekitar Kita" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "⚡ Jenis-Jenis Aktuator" },
        {
          type: "paragraph",
    ...
    },
    {
      blocks: [
        {
          type: "heading",
          text: "🤝 Sensor dan Aktuator Selalu Bekerja Bersama",
        },
        {
          type: "paragraph",
