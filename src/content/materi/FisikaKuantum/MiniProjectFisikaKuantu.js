const miniprojectkuantum = {
  ...
  content: [
    ...
    {
      heading: "📂 Pilihan Studi Kasus",
      body: [
        "💻 Komputer membutuhkan kemampuan menghitung yang lebih cepat.",
        "",
        "🏥 Rumah sakit memerlukan alat pencitraan dengan resolusi lebih tinggi.",
        "",
        "🔐 Sebuah perusahaan ingin meningkatkan keamanan komunikasi data.",
        "",
...

    {
      ...
      body: [
        "1. Jelaskan permasalahan yang dipilih.",
        "2. Tentukan konsep fisika kuantum yang digunakan.",
    ...
    {
      heading: "💡 Berpikir seperti Ilmuwan",
      body: [
    ...
    {
      heading: "🌍 Dampak bagi Masyarakat",
      body: [
