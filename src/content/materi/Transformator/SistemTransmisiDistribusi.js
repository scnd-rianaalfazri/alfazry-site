const sistemtansmisidistribusi = {
  ...
  { heading:
    ...
    "⚡ Bagaimana Listrik Sampai ke Rumah Kita?", blocks: [{ type: "heading", text: "⚡ Bagaimana Listrik Sampai ke Rumah Kita?" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🏭 Tahap Pembangkitan", blocks: [{ type: "heading", text: "🏭 Tahap Pembangkitan" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "⬆️ Transmisi Tegangan Tinggi", blocks: [{ type: "heading", text: "⬆️ Transmisi Tegangan Tinggi" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🌉 Jaringan Transmisi", blocks: [{ type: "heading", text: "🌉 Jaringan Transmisi" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "⬇️ Distribusi Tegangan Menengah dan Rendah", blocks: [{ type: "heading", text: "⬇️ Distribusi Tegangan Menengah dan Rendah" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "🏠 Listrik Sampai ke Konsumen", blocks: [{ type: "heading", text: "🏠 Listrik Sampai ke Konsumen" },
    {
      type: "paragraph",
  ...
  { heading:
    ...
    "📉 Mengapa Tegangan Harus Dinaikkan?", blocks: [{ type: "heading", text: "📉 Mengapa Tegangan Harus Dinaikkan?" },
    {
      type: "paragraph",
