...
const fisikasebagaiproduk = {
  ...
  description:
    "Memahami bahwa fisika menghasilkan berbagai bentuk pengetahuan ilmiah seperti fakta, konsep, hukum, prinsip, teori, dan model.",
  ...
  content: [
    {
      blocks: [
        ...
        {
          type: "paragraph",
          text: "Pernahkah kamu bertanya-tanya, mengapa kita bisa tahu dengan sangat yakin kalau Bumi itu mengelilingi Matahari?",
        },
        {
          type: "paragraph",
          text: "Atau mengapa kita sangat percaya kalau benda yang dilepaskan di udara pasti akan langsung jatuh ke bawah?",
        },
        {
          type: "paragraph",
          text: "Semua pengetahuan berharga tersebut tidak muncul secara instan, tidak lewat mimpi semalam, dan jelas bukan hasil cocoklogi.",
        },
        {
          type: "paragraph",
          text: "Kumpulan pengetahuan itu adalah hasil akhir, atau produk, dari proses penyelidikan ilmiah super ketat yang telah dilakukan dan diuji berulang kali oleh para ilmuwan lintas generasi.",
        },
      ],
    },
    {
      blocks: [
        { type: "heading", text: "⚙️ Apa yang Dimaksud Produk dalam Fisika?" },
        {
          type: "image",
        ...
        {
          type: "paragraph",
          text: "Dalam hakikat ilmu fisika, Fisika sebagai Produk (physics as a product) adalah kumpulan atau seluruh hasil pengetahuan yang didapatkan melalui proses ilmiah.",
        },
        {
          type: "paragraph",
          text: "Ibarat sebuah pabrik, jika proses ilmiah adalah mesin dan cara kerjanya, maka pengetahuan-pengetahuan inilah barang jadi yang siap digunakan.",
        },
        {
          type: "paragraph",
          text: "Produk-produk ilmiah ini menjadi fondasi utama bagi peradaban manusia untuk memahami, memprediksi, dan menjelaskan berbagai macam fenomena alam yang terjadi di sekitar kita.",
        },
        {
          type: "paragraph",
          text: "Produk fisika bukanlah satu hal yang monoton. Di dalamnya, kumpulan pengetahuan ini terbagi menjadi beberapa bentuk utama. Mari kita bedah satu per satu:",
        },
      ],
    },
    {
      blocks: [
        { type: "heading", text: "Produk Fisika yang Pertama: 📌 Fakta" },
        {
          type: "image",
          src: faktafisikaImg,
    ...
    {
      blocks: [
        { type: "heading", text: "Produk Fisika yang Kedua:💡 Konsep" },
        {
          type: "image",
          src: konsepfisikaImg,
        ...
        {
          type: "paragraph",
          text: "Istilah-istilah seperti Gaya, Energi, Usaha, dan Momentum.",
        },
      ],
    },
    {
      blocks: [
        { type: "heading", text: "Produk Fisika yang Ketiga:📏 Prinsip" },
        {
          type: "image",
        ...
        {
          type: "paragraph",
          text: "Prinsip Kekekalan Energi menyatakan bahwa energi tidak dapat diciptakan maupun dimusnahkan, melainkan hanya dapat berubah dari satu bentuk ke bentuk energi lainnya.",
        },
      ],
    },
    {
      blocks: [
        { type: "heading", text: "Produk Fisika yang Keempat:⚖️ Hukum" },
        {
          type: "image",
          src: hukumfisikaImg,
        ...
        {
          type: "paragraph",
          text: "Hukum dirumuskan berdasarkan hasil pengamatan dan eksperimen yang sangat konsisten.",
        },
        { type: "paragraph", text: "Contoh:" },
        {
          type: "list",
    ...
    {
      blocks: [
        { type: "heading", text: "Produk Fisika yang Kelima: 🌌 Teori" },
        {
          type: "image",
          src: teorifisikaImg,
    ...
    {
      blocks: [
        { type: "heading", text: "Dan yang terakhir: 🧱 Model" },
        {
          type: "image",
          src: modelfisikaImg,
    ...
    {
      blocks: [
        { type: "heading", text: "🌍 Mengapa Produk Fisika Penting?" },
        {
          type: "image",
        ...
        {
          type: "paragraph",
          text: "Tanpa adanya produk fisika berupa konsep, hukum, dan teori, kita akan hidup dalam kegelapan tanpa tahu cara kerja semesta.",
        },
        {
          type: "paragraph",
          text: "Produk fisika inilah yang menjadi bahan bakar utama bagi perkembangan teknologi modern.",
        },
        {
          type: "paragraph",
          text: "Gadget yang kamu pegang sekarang, internet, satelit, hingga kendaraan listrik semuanya bisa ada karena manusia berhasil merumuskan produk-produk fisika ini!",
        },
      ],
    },
    {
      blocks: [
        ...
        { type: "image", src: tahukahkamuImg, caption: "Hukum vs teori" },
        {
          type: "paragraph",
          text: "Banyak orang salah mengira kalau teori bisa 'naik kelas' menjadi hukum jika sudah makin terbukti.",
        },
        { type: "paragraph", text: "Itu miskonsepsi!" },
        {
          type: "paragraph",
          text: "Hukum dan teori punya peran yang berbeda secara total:",
        },
        {
          type: "list",
          list: {
    ...
    },
    {
      blocks: [
        ...
        {
          type: "paragraph",
          text: "'Yaa, itu kan baru sebatas 'Teori Ilmiah', berarti masih sekadar dugaan atau tebakan kosong dong?' ❌.",
        },
        {
          type: "paragraph",
          text: "Gak, gitu! Dalam bahasa sehari-hari, kata 'teori' sering diartikan sebagai omong kosong atau asumsi",
        },
        {
          type: "paragraph",
          text: "Tapi dalam dunia sains, Teori Ilmiah adalah kasta penjelasan tertinggi.",
        },
        {
          type: "paragraph",
          text: "Sebuah gagasan baru bisa diakui sebagai teori setelah lolos uji validasi ekstrem, didukung oleh banyak bukti empiris, dan belum bisa dipatahkan oleh eksperimen apa pun.",
        },
      ],
    },
    {
      blocks: [
        ...
        { type: "paragraph", text: "Proses Ilmiah" },
        { type: "paragraph", text: "⬇️" },
        { type: "paragraph", text: "Fakta" },
        { type: "paragraph", text: "⬇️" },
        { type: "paragraph", text: "Konsep" },
        { type: "paragraph", text: "⬇️" },
        { type: "paragraph", text: "Prinsip" },
        { type: "paragraph", text: "⬇️" },
        { type: "paragraph", text: "Hukum" },
        { type: "paragraph", text: "⬇️" },
        { type: "paragraph", text: "Teori" },
        { type: "paragraph", text: "⬇️" },
        { type: "paragraph", text: "Model" },
      ],
    },
    {
      blocks: [
        ...
        {
          type: "paragraph",
          text: "Fisika sebagai produk merupakan perpustakaan besar berisi kumpulan pengetahuan ilmiah yang dihasilkan secara valid melalui metode penyelidikan ilmiah.",
        },
        {
          type: "paragraph",
          text: "Produk inilah yang kita gunakan untuk membaca rahasia alam semesta dan menciptakan teknologi masa depan.",
        },
      ],
    },
    {
        ...
        { type: "heading", text: "🎯 Quick Check" },
        {
          ...
          data: {
            questions: [
              ...
              {
                question: "Manakah contoh konsep dalam fisika?.",
                options: [
                  "Hukum Newton",
                  "Teori Relativitas",
                  "Energi",
              ...
              {
                question:
                  "Pernyataan 'Benda yang dilepaskan akan jatuh menuju permukaan Bumi' merupakan contoh....",
                options: ["Fakta", "Prinsip", "Teori", "Konsep", "Model"],

                answerIndex: 0,
              },
              {
                question:
                  "Pernyataan yang benar mengenai hukum dan teori ilmiah adalah....",
                options: [
              ...
              {
                question: "Mengapa model digunakan dalam fisika?",
                options: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "Sekarang kamu sudah tahu, kan? Apa saja wujud 'produk' yang dihasilkan dalam fisika?",
        },
        {
          type: "paragraph",
          text: "Tapi, bagaimana cara para ilmuwan terdahulu bisa memproses dan menemukan semua rumus, hukum, dan teori keren ini?",
        },
        {
          type: "paragraph",
          text: "➡️ Next, kita menuju portal: Fisika sebagai Proses.",
        },
      ],
    },
    {
