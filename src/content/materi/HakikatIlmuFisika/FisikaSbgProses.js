  ...
  content: [
    ...
    },
    {
      blocks: [
        {
          type: "heading",
          text: "🧪 Apa yang Dimaksud Fisika sebagai Proses?",
        },
        {
          type: "image",
        ...
        items: [
          {
            ...
            description:
              "Melihat dan mencermati kejadian unik di sekitar alam.",
          },
          {
            text: "❓ Mengajukan pertanyaan",
            description:
              "Merumuskan masalah yang ingin dipecahkan (Mengapa? Bagaimana?).",
          },
          {
          ...
          },
          {
            ...
            description:
              "Menguji hipotesis secara langsung melalui serangkaian percobaan terkontrol.",
          },
          {
            text: "📊 Menganalisis data",
            description:
              "Mengolah, membaca, dan menginterpretasikan angka atau hasil dari eksperimen.",
          },
          {
            text: "📖 Menarik kesimpulan",
            description:
              "Menentukan apakah data eksperimen mendukung atau justru membantah hipotesis awal.",
          },
        ],
      },
      blocks: [
        { type: "heading", text: "🔄 Bagaimana Pengetahuan Fisika Dibangun?" },
    ...
    {
      blocks: [
        { type: "heading", text: "🔍 Mengapa Harus Berdasarkan Bukti?" },
        {
          type: "image",
    ...
    {
      blocks: [
        { type: "heading", text: "🔁 Proses yang Terus Berulang" },
        {
          type: "image",
