...
const fisikasbgsikap = {
  ...
  content: [{ blocks: [{ type: "image", src:
      ...
      FisikaSgbSikapImg, caption:
      "Sikap ilmiah membantu kita mengambil keputusan berdasarkan bukti, bukan sekadar dugaan." }, { type: "paragraph", text: "Bayangkan dua orang melakukan percobaan." }, { type: "paragraph", text: "Orang pertama langsung menyimpulkan hasilnya tanpa mengukur." }, { type: "paragraph", text: "Orang kedua mengamati dengan teliti, mencatat data, lalu menarik kesimpulan berdasarkan bukti." }, { type: "paragraph", text: "Siapa yang lebih bersikap ilmiah?" }] }, { blocks: [{ type: "heading", text:
      ...
      "🧠 Apa Itu Sikap Ilmiah?" }, { type: "image", src:

      PengertianSikapIlmiahImg, caption: "Perbandingan dua cara berpikir" }, { type: "paragraph", text: "Sikap ilmiah adalah cara berpikir dan bertindak yang mendukung proses memperoleh pengetahuan secara objektif." }, { type: "paragraph", text: "Sikap ini tidak secara esklusif hanya untuk para ilmuwan atau profesor yang bekerja di dalam laboratorium canggih saja." }, { type: "paragraph", text: "Sikap ilmiah sebenarnya sangat berguna dan bisa kita terapkan dalam kehidupan sehari-hari demi menyaring informasi dan mengambil keputusan yang bijak." }] }, { blocks: [{ type: "heading", text:
      ...
      "🌟 Mengapa Sikap Ilmiah Penting?" }, { type: "image", src:
      diagramsikapImg, caption:
      "Diagram sikap ilmiah" }, { type: "paragraph", text: "Di era derasnya arus informasi seperti sekarang, memiliki sikap ilmiah bertindak sebagai 'filter' mental kita." }, { type: "paragraph", text: "Dengan menanamkan sikap ilmiah, kita dapat:" }, { type: "list", list:
      ...
      "🔍 Sikap-Sikap Ilmiah" }, { type: "image", src:

      sikapilmuanImg, caption: "Sikap-sikap ilmiah" }, { type: "paragraph", text: "Untuk menjadi pribadi yang ilmiah, berikut adalah beberapa pilar sikap yang perlu kita asah:" }, { type: "list", list:
      ...
      "🌍 Contoh dalam Kehidupan" }, { type: "list", list:
      {
        type: "ordered",
        items: [
        {
      ...
      "💡 Tahukah Kamu?" }, { type: "paragraph", text: "Banyak penemuan besar sains yang mengubah dunia justru tidak berawal dari formula rumit nan megah, melainkan dari rasa ingin tahu terhadap hal-hal sederhana di sekitar kita yang sering dilewatkan orang lain." }, { type: "paragraph", text: "Contohnya, Sir Isaac Newton yang penasaran dengan jatuhnya buah apel hingga akhirnya merumuskan Teori Gravitasi Universal!" }] }, { blocks: [{ type: "heading", text:
      ...
      "⚠️ Miskonsepsi" }, { type: "paragraph", text: "'Berarti kalau bersikap ilmiah, kita harus jadi orang skeptis yang meragukan segala hal di dunia ini dong?' ❌" }, { type: "paragraph", text: "Gak, gitu! Sikap ilmiah bukan berarti selalu meragukan semua hal tanpa akhir. Sikap ilmiah berarti kita bersedia menerima atau menolak suatu pendapat secara rasional berdasarkan bukti yang dapat dipertanggungjawabkan secara nyata." }] }, { blocks: [{ type: "heading", text:
      ...
      "📊 Ringkasan Konsep" }, { type: "paragraph", text: "Rasa Ingin Tahu" }, { type: "paragraph", text: "⬇️" }, { type: "paragraph", text: "Pengamatan" }, { type: "paragraph", text: "⬇️" }, { type: "paragraph", text: "Data" }, { type: "paragraph", text: "⬇️" }, { type: "paragraph", text: "Analisis" }, { type: "paragraph", text: "⬇️" }, { type: "paragraph", text: "Kesimpulan yang Objektif" }] }, { blocks: [{ type: "heading", text:
      ...
      "✨ Inti Materi (Takeaway Message)" }, { type: "paragraph", text: "Sikap ilmiah merupakan fondasi paling mendasar dalam mempelajari ilmu fisika maupun saat melakukan penelitian sains lainnya." }, { type: "paragraph", text: "Dengan mempraktikkan sikap jujur, teliti, kritis, dan terbuka terhadap kebenaran bukti, kita tidak hanya mampu memperoleh pengetahuan yang lebih dapat dipercaya, tetapi juga melatih diri menjadi individu yang bijak dalam berpikir sehari-hari." }] }, { blocks: [{ type: "heading", text:
    ...
    link: "/materi/ruang-lingkup-fisika", blocks: [{ type: "paragraph", text: "Apakah kamu memahami apa itu sikap ilmiah sebagai salah satu pilar hakikat fisika?" }, { type: "paragraph", text: "Namun, setelah memiliki sikap ini, apa saja sih kapling atau bidang luas yang dipelajari di dalam fisika?" }, { type: "paragraph", text: "➡️ Next, kita menuju portal: Ruang Lingkup Fisika." }] }, { blocks: [{ type: "heading", text:
