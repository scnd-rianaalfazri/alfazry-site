...
const fisikasbgsikap = {
  ...
  { heading:
    ...
    "🧠 Apa Itu Sikap Ilmiah?", blocks: [{ type: "heading", text: "🧠 Apa Itu Sikap Ilmiah?" },
    {
      type: "image",
  ...
  { heading:
    ...
    "🌟 Mengapa Sikap Ilmiah Penting?", blocks: [{ type: "heading", text: "🌟 Mengapa Sikap Ilmiah Penting?" },
    {
      type: "image",
      src: diagramsikapImg,
  ...
  { heading: "🌍 Contoh dalam Kehidupan", 
    blocks: [
      {
        type: "image",
        src: contohdlmkehidupanImg,
        caption: "Contoh dalam kehidupan"
      },
      {
        type: "list",
        list: {
  ...
  { heading: "💡 Tahukah Kamu?", 
    ...
    { heading: "📊 Ringkasan Konsep", blocks: [
      { type: "paragraph", 
        text: "Rasa Ingin Tahu" 
      },
      { type: "paragraph", 
      ...
      { type: "paragraph", 
        text: "Kesimpulan yang Objektif" 
      }]
    },
    { heading: "✨ Inti Materi (Takeaway Message)", 
      blocks: [
        { type: "heading", 
          text: "✨ Inti Materi (Takeaway Message)" 
        },
        {
          type: "paragraph",
