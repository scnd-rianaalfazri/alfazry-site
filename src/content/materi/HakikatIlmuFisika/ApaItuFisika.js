...
const apaitufisika = {
  ...
  content: [{ blocks: [{ type: "image", src:
      ...
      apaitufisikaImg, caption:
      "Apa itu fisika?" }, { type: "paragraph", text: "📸 Gerbang Utama Menuju Rahasia Semesta" }, { type: "paragraph", text: "Coba sejenak kamu pause kesibukanmu dan perhatikan sekelilingmu. (ILUSTRASI 👇)" }, { type: "list", list:
      ...
      "🔬 Fisika di Sekeliling Kita" }, { type: "image", src:
      fisikadisekelilingImg, caption:
      "Fisika di sekitar kita" }, { type: "paragraph", text: "Apakah semua kejadian itu terjadi secara kebetulan atau karena sihir?" }, { type: "paragraph", text: "Tentu tidak!" }, { type: "paragraph", text: "Semua fenomena tersebut diatur oleh skenario besar bernama hukum-hukum alam, dan ilmu yang bertugas membongkar rahasia di balik hukum alam itu adalah Fisika." }] }, { blocks: [{ type: "heading", text:
      ...
      "🔬 Pengertian Fisika" }, { type: "image", src:
      pengertianfisikaImg, caption:
      "Fenomena alam hingga penjelasan ilmiah" }, { type: "paragraph", text: "Secara ilmiah, Fisika adalah cabang ilmu pengetahuan alam (sains) yang mempelajari materi, energi, gerak, gaya, ruang, waktu, beserta interaksi kompleks di antara semuanya." }, { type: "paragraph", text: "Melalui fisika, manusia berusaha menguraikan source code alias cara kerja alam semesta." }, { type: "paragraph", text: "Kita tidak tebak-tebakan, melainkan menggunakan fondasi kuat berupa pengamatan yang presisi, eksperimen yang terukur, serta penalaran ilmiah yang logis." }] }, { blocks: [{ type: "heading", text:
      ...
      "🌌 Apa yang Dipelajari Fisika?" }, { type: "image", src:
      skalalingkupfisikaImg, caption:
      "Skala alam semesta dalam grafik" }, { type: "paragraph", text: "Ruang lingkup objek kajian fisika itu bener-bener mind-blowing karena skalanya yang sangat ekstrem!" }, { type: "explanation", text:
      ...
      [
      "Karena mencakup segala hal dari yang terkecil sampai yang terbesar di semesta ini, tidak heran kalau fisika sering dijuluki sebagai ilmu dasar (the fundamental science) bagi banyak cabang sains lainnya."] }, { type: "list", list: { type: "unordered", items: [{ text: "Skala Mikroskopis", description: "Fisika masuk ke dunia super kecil, membedah partikel-partikel fundamental yang ukurannya jauh lebih mini daripada atom (seperti elektron dan kuark)." }, { text: "Skala Kosmis", description: "Fisika melompat jauh ke luar angkasa untuk meneropong struktur alam semesta yang super raksasa, galaksi, hingga black hole." }] } }] }, { blocks: [{ type: "heading", text:




      "🧩 Cabang-Cabang Fisika" }, { type: "image", src:
      cabangfisikaImg, caption:
      "Beberapa cabang ilmu fisika" }, { type: "paragraph", text: "Agar pembahasannya tidak tumpang tindih, ilmu fisika dibagi ke dalam beberapa era dan disiplin." }, { type: "paragraph", text: "Berikut adalah peta cabang fisika yang dijamin bikin kita makin kagum sama cara kerja semesta:" }, { type: "list", list:
      ...
      "🌍 Mengapa Fisika Disebut Ilmu Dasar?" }, { type: "paragraph", text: "Sederhana saja!" }, { type: "list", list:
      ...
      "🚀 Fisika dalam Kehidupan" }, { type: "paragraph", text: "Fisika hadir hampir di setiap teknologi modern." }, { type: "list", list:
      ...
      fisikadalamkehidupanImg, caption:
      "Fisikawan berinovasi di berbagai bidang" }, { type: "paragraph", text: "Fisikawan itu tidak selalu berakhir menjadi profesor berkacamata tebal yang mengurung diri di laboratorium, lho!" }, { type: "paragraph", text: "Kemampuan problem solving dan pemodelan matematis anak fisika membuat mereka banyak dicari di berbagai industri kreatif, perusahaan teknologi raksasa (Tech Giants), lembaga antariksa (seperti NASA/BRIN), dunia finansial, hingga pengembangan Artificial Intelligence (AI)." }] }, { blocks: [{ type: "heading", text:
      ...
      miskonsepsiaoaitufisikaImg, caption:
      "Miskonsepsi umum tentang fisika" }, { type: "paragraph", text: "'Fisika itu kan cuma ilmu yang mempelajari benda bergerak dan menghitung kecepatan mobil lewat rumus, ya?' ❌" }, { type: "paragraph", text: "Wah, itu sempit banget! Gerak benda hanyalah satu dari sekian banyak menu di dalam fisika." }, { type: "paragraph", text: "Fisika juga mempelajari hal-hal tak kasat mata seperti radiasi cahaya, aliran kalor, arus listrik, gelombang wifi, hingga sifat dasar dari ruang dan waktu itu sendiri." }, { type: "paragraph", text: "Jadi, jangan cuma batasi fisika hanya sebatas rumus kecepatan (v = s/t)" }] }, { blocks: [{ type: "heading", text:
      ...
      "🧠 Inti Materi (Takeaway Message)" }, { type: "paragraph", text: "Fisika adalah ilmu yang mempelajari hukum-hukum fundamental alam semesta untuk menjelaskan berbagai fenomena, mulai dari skala sub-atomik (mikroskopis) yang tak kasat mata hingga skala kosmik (makroskopis) yang megah." }] }, { blocks: [{ type: "heading", text:
      ...
      "🔍 Coba Temukan?" }, { type: "image", src:
      cobatemukanImg, caption:
      "Coba temukan fenomena fisika di sekitar gambar ini!" }] }, { blocks: [{ type: "heading", text:
    ...
    link: "/materi/hakikat-ilmu-fisika", blocks: [{ type: "image", src: nextmissionhakikatilmufisikaImg, caption: "🚀 KLIK GAMBAR INI! Kamu bisa menuju ke portal berikutnya." }, { type: "paragraph", text: "Mungkin, sekarang kamu sudah apa itu fisika serta cabang-cabang serunya." }, { type: "paragraph", text: "Namun, setelah tahu objek kajiannya, apa sebenarnya esensi atau 'Hakikat' dari ilmu fisika itu sendiri bagi peradaban?" }, { type: "paragraph", text: "➡️ Next, kita menuju portal: Hakikat Ilmu Fisika." }] }, { blocks: [{ type: "heading", text:
