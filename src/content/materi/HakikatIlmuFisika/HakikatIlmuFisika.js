...
const hakikatimufisika = {
  ...
  description:
    "Memahami hakikat ilmu fisika sebagai produk, proses, dan sikap ilmiah dalam mempelajari alam.",
  ...
  content: [
    ...
    {
      blocks: [
        { type: "heading", text: "🌱 Apa yang Dimaksud Hakikat Ilmu Fisika?" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "🧩 Tiga Pilar Hakikat Fisika" },
        {
          type: "image",
        ...
        { type: "paragraph", text: "🧠 Fisika sebagai Sikap Ilmiah" },
      ],
    },
    {
      blocks: [
        { type: "heading", text: "⚙️ Fisika sebagai Produk" },
        {
          type: "image",
    ...
    {
      blocks: [
        { type: "heading", text: "🧪 Fisika sebagai Proses" },
        {
          type: "image",
    ...
    {
      blocks: [
        { type: "heading", text: "🧠 Fisika sebagai Sikap" },
        {
          type: "image",
    ...
    {
      blocks: [
        { type: "heading", text: "🌍 Mengapa Hakikat Fisika Penting?" },
        {
          type: "paragraph",
    ...
    },
    {
      blocks: [
        ...
        { type: "paragraph", text: "Fisika" },
        { type: "paragraph", text: "⬇️" },
        { type: "paragraph", text: "Produk" },
        { type: "paragraph", text: "⬇️" },
        { type: "paragraph", text: "Proses" },
        { type: "paragraph", text: "⬇️" },
        ...
        { type: "heading", text: "🎯 Quick Check" },
        {
          ...
          data: {
            questions: [
              ...
              {
                question:
                  "Seorang ilmuwan melakukan pengamatan, menyusun hipotesis, melakukan eksperimen, lalu menarik kesimpulan. Kegiatan tersebut menunjukkan fisika sebagai....",
                options: ["Produk", "Proses", "Sikap", "Teknologi"],
