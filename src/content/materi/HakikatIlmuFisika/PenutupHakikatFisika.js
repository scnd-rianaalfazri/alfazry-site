const penutuphakikatilmufisika = {
  ...
  content: [
    ...
    {
      blocks: [
        { type: "heading", text: "🗺️ Perjalanan yang Telah Kamu Tempuh" },
    ...
    {
      blocks: [
        { type: "heading", text: "🧠 Apa yang Telah Kamu Kuasai?" },
    ...
    {
      blocks: [
        { type: "heading", text: "🌱 Belajar Tidak Berhenti di Sini" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "💡 Einstein Insight" },
        {
          type: "paragraph",
    ...
    {
      blocks: [
        { type: "heading", text: "⚠️ Pesan Penting" },
    ...
    {
      blocks: [
        { type: "heading", text: "💭 Refleksi Diri" },
        {
          type: "paragraph",
