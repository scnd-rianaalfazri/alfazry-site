...
const ruanglingkupfisika = {
  ...
  content: [{ blocks: [{ type: "paragraph", text: "Apakah fisika cuma membahas rumus menggelindingkan balok atau menghitung kecepatan mobil ngerem??" }, { type: "paragraph", text: "Ternyata tidak. Fisika memiliki ruang lingkup yang sangat luas, mulai dari gerakan semut sekecil debu di tanah hingga pergerakan galaksi raksasa di ujung semesta." }, { type: "paragraph", text: "Secara mendasar, fisika mempelajari materi, energi, gerak, gaya, ruang, waktu, beserta seluruh interaksi yang menyertainya." }] }, { blocks: [{ type: "heading", text:
      ...
      "🧭 Peta Ruang Lingkup Fisika" }, { type: "paragraph", text: "Ruang lingkup yang luas ini dipetakan ke dalam dua era utama, plus satu ranah inovasi terapan" }] }, { blocks: [{ type: "heading", text:




      "Pendalaman Era Fisika Klasik (Makro & Dapat Diprediksi)" }, { type: "paragraph", text: "Fisika klasik adalah pondasi utama yang menjelaskan fenomena yang bisa kita tangkap dengan indra kita secara langsung. Berikut contoh fenomenanya" }, { type: "list", list:
      ...
      "Pendalaman Era Fisika Modern (Mikro & Penuh Kejutan)" }, { type: "paragraph", text: "Ketika para ilmuwan mencoba meneliti sesuatu yang skalanya ekstrem—seperti objek yang bergerak secepat cahaya, objek sekecil atom, atau objek super masif seperti bintang—hukum fisika klasik runtuh dan tidak berlaku lagi. Di sinilah Fisika Modern lahir membawa aturan baru:" }, { type: "list", list:
      ...
      "Fisika Terapan & Interdisipliner (Inovasi Masa Depan)" }, { type: "paragraph", text: "Fisika tidak melulu diam di dalam laboratorium teori, tetapi juga berkolaborasi dengan cabang ilmu lain untuk menciptakan teknologi baru." }, { type: "list", list:
      ...
      "🌍 Contoh dalam Kehidupan" }, { type: "paragraph", text: "Saat bermain sepak bola:" }, { type: "paragraph", text: "⚽ Gerak bola dipelajari dalam kinematika." }, { type: "paragraph", text: "💪 Tendangan dijelaskan oleh gaya." }, { type: "paragraph", text: "⚡ Energi berpindah dari kaki ke bola." }, { type: "paragraph", text: "🌬️ Hambatan udara dipelajari dalam fluida." }] }, { blocks: [{ type: "heading", text:
      ...
      "🚀 Perjalananmu di Fisika Alfazrian" }, { type: "paragraph", text: "Di website ini, setiap chapter akan membahas satu bidang fisika secara bertahap." }, { type: "paragraph", text: "Semua chapter saling terhubung sehingga membentuk pemahaman yang utuh." }] }, { blocks: [{ type: "heading", text:
      ...
      "💡 Tahukah Kamu?" }, { type: "paragraph", text: "📱 Kompleksitas Sebuah Smartphone" }, { type: "paragraph", text: "Smartphone di tanganmu adalah bukti nyata gabungan berbagai bidang fisika. Gadget tersebut memanfaatkan listrik, gelombang elektromagnetik, optika lensa kamera, fisika material, hingga fisika kuantum pada komponen prosesornya secara bersamaan." }] }, { blocks: [{ type: "heading", text:
      ...
      "⚠️ Miskonsepsi" }, { type: "paragraph", text: "Cabang-cabang fisika bukanlah ilmu kaplingan yang berdiri sendiri-sendiri. " }, { type: "paragraph", text: "Di dunia nyata, berbagai konsep fisika selalu berkolaborasi bersamaan untuk menjelaskan satu fenomena tunggal. " }, { type: "paragraph", text: "Contohnya satelit; untuk memahaminya kita butuh kombinasi konsep gerak, gaya gravitasi, energi, hingga relativitas sekaligus." }] }, { blocks: [{ type: "heading", text:
      ...
      "✨ Inti Materi (Takeaway Message)" }, { type: "paragraph", text: "Fisika memiliki ruang lingkup semesta yang super luas. " }, { type: "paragraph", text: "Meskipun dibagi menjadi banyak bidang kajian demi mempermudah kita belajar, pada akhirnya seluruh konsep fisika saling berkaitan erat untuk menerjemahkan cara alam semesta bekerja." }] }, { blocks: [{ type: "heading", text:
    ...
    link: "/materi/metode-ilmiah", blocks: [{ type: "paragraph", text: "Kita sudah mengetahui apa saja yang dipelajari dalam fisika." }, { type: "paragraph", text: "Namun, bagaimana ilmuwan memperoleh semua pengetahuan tersebut?" }, { type: "paragraph", text: "➡️ Next, kita menuju portal: Metode Ilmiah." }] }, { blocks: [{ type: "heading", text:
