  ...
  return (
    <section className="relative z-10 px-4 sm:px-6 md:px-16 py-16 md:py-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
        ...
        <div>
          <p className="text-cyan-400 uppercase tracking-[0.2em] sm:tracking-[0.3em] text-xs mb-4">
        ...
        <div className="relative">
          ...
          <div className="relative rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 md:p-8 h-64 sm:h-72 md:h-80 flex items-center justify-center overflow-hidden">
            ...
            <div className="text-center z-10">
              <p className="text-cyan-400 text-xs sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.3em] mb-3">
                Simulation Preview
              </p>
